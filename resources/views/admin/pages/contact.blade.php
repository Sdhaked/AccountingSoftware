                    ...
                    <div class="mt-4">
                        ...
                        <ul class="social-list">
                            <li>
                                ...
                                <input type="url" name="url[1]" class="form-control" placeholder="Social Link" value="{{ $social[0]->url ?? '' }}">
                            </li>
                            <li>
                                <select class="form-select" name="platform[2]">
                                    @include('admin._partials.options.social-options', ['selected' => $social[1]->platform ?? ''])
                                </select>
                                <input type="url" name="url[2]" class="form-control" placeholder="Social Link" value="{{ $social[1]->url ?? '' }}">
                            </li>
                            <li>
                                ...
                                <input type="url" name="url[3]" class="form-control" placeholder="Social Link" value="{{ $social[2]->url ?? '' }}">
                            </li>
                            <li>
                                ...
                                <input type="url" name="url[4]" class="form-control" placeholder="Social Link" value="{{ $social[3]->url ?? '' }}">
                            </li>
                        </ul>
                    </div>
                </div>
